...
Original file is located at
    https://colab.research.google.com/drive/1PALNnR_eUbg5ySWGM7eNXOVDEgrYQ4I7
...
def convolutional_block(X, f, filters,stride=2):
    ...
    xSave = Conv2D(filters=f3, kernel_size=(1, 1), strides=(stride, stride), padding="valid", kernel_initializer=keras.initializers.glorot_uniform(seed=0))(xSave)
    xSave = BatchNormalization()(xSave)
...
def ResNet(input_shape=(32, 32, 3), classes=10):
    ...
    # Stage 1
    X = Conv2D(64, kernel_size=(7, 7), strides=(2, 2), kernel_initializer=keras.initializers.glorot_uniform(seed=0))(X)
    X = BatchNormalization()(X)
    X = Activation('relu')(X)
